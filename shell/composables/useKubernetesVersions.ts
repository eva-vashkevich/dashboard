 ...
 *
 * `props` is expected to be the reactive `props` object handed to the owning component's
 * `setup(props)` (or an equivalent reactive object) - accessing its fields inside the computeds
 * below is what gives them proper reactivity tracking.
 */
